...
void CUrlProtocol::GetUrl(Uri &uri,HTTP_PROTOCL_TYPE http_protocl_type)
{
...
int CUrlProtocol::AddApi(HTTP_PROTOCL_TYPE http_protocl_type,HTTP_PROTOCOL http_protocol,const char *api,HTTP_METHOD http_method)
{
