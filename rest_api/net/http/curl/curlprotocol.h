...
public:
	...
	void GetUrl(Uri &uri,HTTP_PROTOCL_TYPE http_protocl_type);

	map<HTTP_PROTOCL_TYPE,Uri> m_urllist;
	std::string domain;
	int AddApi(HTTP_PROTOCL_TYPE http_protocl_type,HTTP_PROTOCOL http_protocol,const char *api,HTTP_METHOD http_method);
